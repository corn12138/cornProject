...
import { tabs } from '../../pages/home/tabPages';
...
const Navigation: FC<NavProps> = (props) => {
  return (
    <div className={' bg-white w-screen shadow-lg overflow-hidden ' + props.className}>
        <div className=' max-w-6xl mx-auto my-0 flex justify-center'>
            <div className={`h-14 flex-col relative duration-300 transition-all ${props.hide ? " top-0" : '-top-14'}`}>
